                        ...
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                <ul>
                                    ...
                                    <li><Link href={route('dashboard')}>Housemate</Link></li>
                                    <li><Link href={route('dashboard')}>Roommates</Link></li>
                                    <li><Link href={route('dashboard')}>Rentals</Link></li>
                                    <li><Link href={route('dashboard')}>Contact</Link></li>
                                    </ul>
                                        {auth.user ? (
                                            <Link
